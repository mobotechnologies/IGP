...
<?php
    ...
    <div class="container-fluid mt--7" id="bgcontain">
      ...
      <div class="row">
        <div class="col">
          <div class="card shadow manualalign blacky">
            <div class="card-header border-0">
              <h3 class="mb-0 visitreporthead"><img src="<?php echo base_url(); ?>assets/images/visitor.png" alt="home.png" style="width: 28px;margin-left: 20%;"/>Visitor Report</h3>
            </div>
			<div class="card-header">
			 
					<form method="post" action="filter_visitor">
