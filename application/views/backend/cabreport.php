        ...
        <div class="col">
          <div class="card shadow blacky">
            <div class="card-header border-0">
              <h3 class="mb-0"> <img src="<?php echo base_url(); ?>/assets/img/icons/cab.png" alt="material.png"  id="material" style="margin-left:28%" /> Cab Report</h3>
            </div>
			<div class="card-body">
			    <div class="container">
					<form method="post" action="filter_cab">
