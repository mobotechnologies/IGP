                    ...
                    <div class="col-7">
                        <div class="card card-outline-info">
                            <div class="card-header">
                                <h4 style="padding-left: 33%;"><img src="<?php echo base_url(); ?>/assets/img/icons/department.png" alt="material.png" style="width: 32px;margin-right: 10px;" />Department List<i class="fa fa-plus" aria-hidden="true" style="margin-left: 102px;"  data-toggle="modal" data-target="#adddepartment"></i></h4>
                            </div>
