...
class Upload extends CI_Controller 
{
		public function imageup()
	{
			   ...
			   // We only need to handle POST requests:
				...
				rename($original,'./assets/photo/uploads/original/'.$filename);
				$original = './assets/photo/uploads/original/'.$filename;
				...
				imagejpeg($newImage,'./assets/photo/uploads/thumbs/'.$filename);
